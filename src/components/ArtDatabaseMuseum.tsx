    ...
    <>
      <div className="border border-dark border-5 rounded p-3">
        ...
        <ul className="list-unstyled mt-3">
          ...
          <li className="list-item h5">
            &#8226; Designed the website with Bulma CSS framework, like image carousel, list displays.
          </li>
          <li className="list-item h5">
            &#8226; Coordinated the database, back end and front end.
          </li>
        </ul>
      </div>
    </>
...
export default ArtDatabaseMuseum;
